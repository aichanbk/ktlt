...
int main()
{
    vector<DT> dt;
    int n;
    cout << "Nguyen Thanh Ha - 20210298 - 2022.2 - 727635:" << endl;
    cout << "Nhap so luong da thuc: ";
    cin >> n;
    while (true)
    {
        cout << "******************************************" << endl;
        cout << "Nguyen Thanh Ha - 20210298 - 20210298 - 727635:" << endl;
        ...
        case 2:
        {
            ...
            for (DT v : dt)
            {
                ...
                for (int i = v.bac; i >= 0; i--)
                {
                    ...
                    if(v.heSo[i] > 0 && i == v.bac){
                        cout<<v.heSo[i]<<"*x^"<<i<<" ";
                    }else if(v.heSo[i] < 0 && i == v.bac){
                        cout<<"- "<<abs(v.heSo[i])<<"*x^"<<i<<" ";
                    }
                    if (i == 0)
                    {
                        if (v.heSo[i] > 0)
                    ...
                    {
                        if (v.heSo[i] != 0 && v.heSo[i] > 0 && i != v.bac)
                        {
                            cout << "+ " << v.heSo[i] << "*x^" << i << " ";
                        }
                        else if (v.heSo[i] != 0 && v.heSo[i] < 0 && i != v.bac)
                        {
                            cout << "- " << abs(v.heSo[i]) << "*x^" << i << " ";
                        }
                    }
